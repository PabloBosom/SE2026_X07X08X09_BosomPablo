...
/********PROTOTIPOS PAR LAS FUNCIONES DEL LCD************/
extern bool LEDrun;
...
osThreadId_t TID_Led;
 ...
 //LCD
 static MSGQUEUE_OBJ_t_LCD msg_lcd; 
...
//	LCD_Clean();
  ...
  osDelay(50);
  snprintf(msg_lcd.Buf,sizeof(msg_lcd.Buf),"IP4:%-16s",ip_ascii); 
  msg_lcd.Idx = 0;
...
//  Buttons_Initialize();
  ...
  mid_MsgQueue_LCD =  osMessageQueueNew(4, sizeof(MSGQUEUE_OBJ_t_LCD), NULL); //Cola para inicializar el display 
